---
title: "19. A kétpólusú világrend kialakulása"
...
- **Meghatározó Dátumok / Időszakok:**
  ...
  - **1948-1949:** A berlini blokád és Németország kettéosztása.
  - **1949:** A NATO és a KGST megalakulása, a szovjet atombomba elkészülése.
...
- **A "vasfüggöny" leereszkedése:** A Szovjetunió Kelet-Európában (Lengyelország, Magyarország, Csehszlovákia stb.) felszámolta a többpártrendszert és kiépítette a kommunista diktatúrákat.
- **Amerikai reakció:**
  - **Truman-doktrína (1947):** Az USA katonai és gazdasági segítséget ígért minden országnak, amelyet a kommunista terjeszkedés fenyeget (pl. Görögország, Törökország).
...
- **Németország kérdése:**
  - **Berlini blokád (1948-49):** Sztálin lezárta a Nyugat-Berlinbe vezető szárazföldi utakat, hogy kikényszerítse a nyugati hatalmak kivonulását. Az USA **légihíddal** látta el a várost, a blokád végül kudarcot vallott.
...
- **Katonai szövetségek létrejötte:**
  ...
  - **Varsói Szerződés (1955):** A Szovjetunió és a keleti blokk országainak katonai szövetsége, a NATO ellensúlyozására.
...
- **Koreai háború (1950-1953):** A szovjetek által támogatott Észak-Korea megtámadta az USA által támogatott Dél-Koreát. A háborúba kínai és ENSZ (főleg amerikai) csapatok is beavatkoztak. A konfliktus fegyverszünettel zárult, amely visszaállította a háború előtti határokat a 38. szélességi fok mentén.
- **Kubai rakétaválság (1962):** A Szovjetunió atomrakétákat telepített Kubába, az USA közvetlen közelébe. Kennedy elnök tengeri blokád alá vonta Kubát. A világ az atomháború szélére sodródott. Végül Hruscsov visszavonta a rakétákat, cserébe az USA ígéretet tett Kuba inváziójának elkerülésére és az amerikai rakéták leszerelésére Törökországból.
- **Vietnámi háború (kb. 1955-1975):** A kommunista Észak-Vietnam (Szovjetunió és Kína támogatásával) és a dél-vietnámi partizánok harcoltak a Dél-Vietnami Köztársaság (USA támogatásával) ellen. A hosszú és véres háború hatalmas amerikai presztízsveszteséggel és végül 1975-ben Észak-Vietnam győzelmével, az ország egyesítésével zárult.
- **Szovjet invázió Afganisztánban (1979):** A szovjet beavatkozás egy kommunista kormány támogatására elhúzódó gerillaháborúhoz vezetett, amelyet az USA támogatott. Ez a konfliktus a Szovjetunió "vietnámi háborújává" vált és hozzájárult a gazdasági kimerüléséhez.
...
- **Fegyverkezési verseny:** Mindkét szuperhatalom óriási összegeket költött hadserege fejlesztésére, különösen a nukleáris fegyverekre. Létrejött az ún. **"terror egyensúlya"**, ahol a kölcsönös megsemmisítéstől való félelem tartotta vissza a feleket a közvetlen háborútól.
- **Helyi háborúk:** A szuperhatalmak a "harmadik világban" (Ázsia, Afrika, Latin-Amerika) vívták meg konfliktusaikat, helyi erőket támogatva.
- **A gyarmati rendszer felbomlása:** A hidegháborús versengés felgyorsította a gyarmati rendszer felszámolását, mivel mindkét szuperhatalom igyekezett a frissen függetlenné váló országokat a saját befolyási övezetébe vonni.
...
- **Közvetlen Következmények:**
  ...
  - **Technológiai verseny:** A katonai rivalizálás (pl. rakétatechnológia) hatalmas lökést adott a tudományos-technikai fejlődésnek, amelynek egyik mellékterméke az **űrverseny** volt (első műhold, első ember az űrben, holdra szállás).
- **Hosszú Távú Hatások:**
  - **A Szovjetunió összeomlása:** A fegyverkezési verseny gazdaságilag kimerítette a Szovjetuniót. A tervgazdaság képtelen volt felvenni a versenyt a nyugati technológiai és gazdasági fejlődéssel, ami végül a rendszer belső összeomlásához vezetett.
  - **Az USA egyedüli szuperhatalommá válása:** A hidegháború végével az USA maradt az egyetlen globális szuperhatalom, ami egy **egypólusú világrendet** hozott létre (legalábbis átmenetileg).
  - **Tartós regionális konfliktusok:** A hidegháborús beavatkozások számos máig tartó konfliktusnak ágyaztak meg (pl. Korea kettéosztottsága, instabilitás a Közel-Keleten).

# **Kontextus és Kritika**

## **Összefüggések és Párhuzamok**

- **A gyarmati rendszer felbomlása:** A hidegháború szorosan összekapcsolódik a dekolonizáció folyamatával. A függetlenné váló "harmadik világ" országai (pl. India, Egyiptom) a két tömb versengésének terepévé váltak, de egy részük az **"el nem kötelezettek mozgalmával"** próbált önálló utat találni.
...
- **A felelősség kérdése:**
  - **Hagyományos (nyugati) nézőpont:** A hidegháborúért elsősorban a **szovjet terjeszkedés és a kommunista ideológia agresszivitása** a felelős. Az amerikai politika (pl. Marshall-terv) védekező jellegű válasz volt.
  - **Revizionista nézőpont:** Ez az irányzat (főleg amerikai baloldali történészek) hangsúlyozza az **amerikai gazdasági imperializmus** szerepét. Szerintük az USA a szabad piacok biztosítása érdekében lépett fel agresszíven, és provokálta ki a szovjet reakciót.
  - **Poszt-revizionista nézőpont:** A legtöbb mai történész ezt az álláspontot képviseli. Eszerint a hidegháború a **kölcsönös félreértések, a bizalmatlanság és a mindkét fél által elkövetett hibák** elkerülhetetlen következménye volt. Nem egyetlen fél felelős, hanem a kialakult geopolitikai helyzet és a két, egymástól gyökeresen eltérő rendszer logikája vezetett a konfliktushoz.

## **Örökség és Jelenkori Relevancia**

A hidegháború öröksége máig meghatározó:

- **NATO:** A szervezet ma is létezik, sőt, a volt Varsói Szerződés több országa is csatlakozott hozzá, ami feszültséget generál Oroszországgal.
...
A kétpólusú világrend a második világháború utáni hatalmi átrendeződés és a két győztes szuperhatalom - az USA és a Szovjetunió - közötti kibékíthetetlen ideológiai ellentét következtében jött létre. Ez a szembenállás egy globális, évtizedekig tartó fegyverkezési és politikai versenyt, a hidegháborút eredményezte, amely Európa kettéosztásán túl helyi háborúkon keresztül formálta a világpolitikát. A konfliktus végül a Szovjetunió gazdasági kimerülésével és összeomlásával zárult, ami az amerikai dominanciájú világrendhez vezetett.

## **Válasz a Központi Kérdésre**

A két szuperhatalom rivalizálása alapjaiban formálta át a világrendet azáltal, hogy a világot két, egymással mereven szembenálló katonai, gazdasági és ideológiai tömbre osztotta. Ez a polarizáció konkrét eseményeken - mint a berlini blokád, a koreai és vietnámi háború, valamint a kubai rakétaválság - keresztül mélyült el, ahol a globális nukleáris megsemmisülés kockázata is felmerült. A versengés nemcsak a nemzetközi politikát, hanem a tudományos fejlődést és a gyarmati rendszer felbomlását is meghatározta, tartós örökséget hagyva a 21. századra is.

## **Záró Perspektíva**

A hidegháború története egyben figyelmeztetés arra, hogy az ideológiai merevség és a nagyhatalmi bizalmatlanság hogyan sodorhatja a világot a katasztrófa szélére, miközben paradox módon a kölcsönös elrettentés évtizedekig megakadályozta egy újabb világháború kitörését.
