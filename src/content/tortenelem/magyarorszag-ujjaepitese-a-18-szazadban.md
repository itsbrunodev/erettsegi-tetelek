---
title: "6. Magyarország újjáépítése a 18. században"
description: "A XVIII. századi Magyarország a török kiűzése utáni újjáépítés, a Habsburg Birodalomba való betagozódás és a tudatos telepítések révén kialakuló etnikai sokszínűség kora volt."
startDate:
  {
    date: "1711-05-01",
    description: "A Rákóczi-szabadságharcot lezáró szatmári béke napja, amely elindította az újjáépítés és a Habsburg-rendi kompromisszum korszakát.",
  }
endDate:
  {
    date: "1790-02-20",
    description: "II. József halála, amely lezárta a felvilágosult abszolutizmus reformkorszakát Magyarországon.",
  }
coverImage: true
---
...
- **Kulcsfogalmak:**
  ...
  - **Helytartótanács:** A nádor elnökletével működő központi kormányszerv, amely a végrehajtó hatalmat gyakorolta Budán. A közigazgatás és a gazdaság országos irányítását látta el.
  ...
  - **Csonka társadalom:** Olyan nemzetiségi közösség, amely nem rendelkezett teljes társadalmi rétegződéssel, különösen hiányzott a politikai vezető szerepet betöltő saját nemessége.
...
- **Kiváltó Okok és Előzmények:**
  ...
  - **Népességveszteség:** A 150 éves török háborúk és a Rákóczi-szabadságharc következtében az ország lakossága a Mátyás korabeli szintre esett vissza (~4 millió fő).
  - **Elnéptelenedett területek:** Hatalmas, műveletlen földterületek jöttek létre, főként az Alföldön és a déli országrészekben.
  - **Gazdasági érdekek:**
    - **Udvari érdek:** Az adóalap és a katonai újoncok számának növelése a birodalom megerősítéséért.
...
- **Az Eseménysor Folyamata:** A benépesítés három fő formája:
  ...
  1.  **Belső vándorlás:**
      ...
      - A sűrűbben lakott, hegyvidéki területekről (Észak-Magyarország) a lakosság az Alföld ritkán lakott tájaira húzódott.
      - Résztvevői: **magyarok, szlovákok, ruszinok, románok**.
      - Ösztönzője: A jobb megélhetés reménye és a földesurak által nyújtott kedvezmények (pl. ideiglenes adómentesség).

  2.  **Szervezett betelepítés:**

      - **Állami (udvari) telepítés:** A kormányzat tudatos politikája.
        - Célja: Adófizetők és a birodalomhoz hű katolikus lakosság arányának növelése.
        - Fő célcsoport: **Német (sváb) telepesek**, akiket az elnéptelenedett területekre hoztak (pl. Buda környéke, Baranya, Tolna, Bánát).
      - **Földbirtokosi telepítés:** A nagybirtokosok magánakciói a munkaerőhiány enyhítésére.

  3.  **Bevándorlás (spontán betelepülés):**
      - A Török Birodalom területéről érkező népcsoportok.
      - Legjelentősebb csoport: A **szerbek**, akik a török elnyomás elől menekültek.
      - Az udvar a déli határ védelmére fegyveres határőrként telepítette le őket a **Határőrvidéken**, cserébe kiváltságokat kaptak.

<!-- _[ide a kép rövid leírása: Magyarország etnikai térképe a XVIII. század végén, a főbb nemzetiségi tömbök ábrázolásával.]_ -->

- **Eredmények és Közvetlen Következmények:**
  - **Népességnövekedés:** A század végére Magyarország lakossága több mint a duplájára, kb. 9-10 millió főre nőtt.
  - **Etnikai arányok megváltozása:** A magyarság aránya az összlakosságon belül kb. **40%-ra csökkent**.
...
- **Közvetlen Következmények:**
  ...
  - Létrejött egy többnemzetiségű ország, ahol a különböző népcsoportok jellemzően egymás mellett, keverten éltek.
  - A nemzetiségek társadalmi szerkezete eltérő volt:
    - **Teljes társadalom (nemességgel):** magyarok, horvátok.
    - **Csonka társadalom (főleg jobbágyok):** szlovákok, románok, ruszinok, szerbek.
  - A katolikus vallás fölénye megerősödött az állami telepítések hatására.
...
- **Hosszú Távú Hatások:**
  ...
  - A XVIII. században kialakult etnikai térkép lett a későbbi nemzetiségi konfliktusok és a **XX. századi területi viták (pl. Trianon)** alapja.
...
- **Pragmatikus gazdaságpolitika:** Ez a nézőpont hangsúlyozza, hogy a telepítések elsődleges célja a lakatlan területek termővé tétele, az adóalap növelése és a gazdaság talpra állítása volt. A betelepülők kiválasztása (pl. németek) a szorgalmuk és mezőgazdasági ismereteik miatt történt.
- **Tudatos birodalmi demográfiai politika:** Ez az értékelés kiemeli, hogy a Habsburg-udvar tudatosan törekedett a katolikus és a dinasztiához hű németajkú lakosság arányának növelésére, ezzel is gyengítve a rendi ellenzék bázisát képező protestáns magyar nemességet és a magyar etnikai tömböt.
