...
startDate:
  {
    date: "1517-10-31",
    description: "A reformáció kezdete (Luther fellépése).",
  }
endDate:
  {
    date: "1608",
...
- **Meghatározó Dátumok / Időszakok:**
  ...
  - **1568:** A tordai országgyűlés. Európában egyedülálló módon törvényben rögzítette a lelkiismereti és vallásszabadságot (a prédikálás szabadságát) a négy bevett felekezet (_recepta religio_: katolikus, evangélikus, református, unitárius) számára.
...
- **Társadalmi és szellemi fogékonyság:**
  - **Főurak és nemesek:** A _ius patronatus_ révén saját birtokaikon támogathatták a reformációt.
